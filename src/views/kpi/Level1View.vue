        ...
        <v-row>
            <v-col>
                <v-toolbar height="30px" color="accent">
                    ...
                    <v-toolbar-title>인증키값: {{ this.selectdata.i_kpikey }}</v-toolbar-title>
                </v-toolbar>
            ...
            <v-col>
                ...
                <v-data-table ref="item-table" :headers="itemHead" :items="itemListsselect"                     
                    ...
                    :items-per-page="-1" 
                    class="elevation-1 text-no-wrap"  max-height="550px" height="550px" 
                    >
                </v-data-table>
    ...
    data() {
        return {
            ...
            itemHead: [
                ...
                {text: '결과',       value: 'f_err',  sortable: false, align:'center', width: "55px"},
