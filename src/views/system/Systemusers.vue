    ...
    data() {
        return {
            headers: [
                ...
                {text: '접속일',  value: 'd_login_at', sortable: false, align:'center', width: "200px"}, 
                {text: '생성일',  value: 'd_create_at', sortable: false, align:'center', width: "200px"}, 
                {text: '갱신일',  value: 'd_update_at', sortable: false, align:'center', width: "200px"}, 
